...
export const metadata: Metadata = {
  ...
  description:
    "Frost locks the keyboard, mouse, and trackpad on macOS while the screen stays visible. Touch ID or a paired Apple Watch releases the lock. Free, no account, source public.",
