...
Built with [Next.js](https://nextjs.org) (App Router), Tailwind CSS v4, and TypeScript. Deployed on Vercel. The interface implements **Axis** (Abdeen Labs brand v3.3): one role-token set driving a canonical dark mode and a first-class light mode.
